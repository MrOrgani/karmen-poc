...
const CATEGORY_META: Record<
  RedFlagCategory,
  { title: string; icon: typeof TrendingUp }
> = {
...
export function RulesDiagnostic({ items }: Props) {
  ...
  const grouped: Record<RedFlagCategory, RuleDiagnosticItem[]> = {
    financial: [],
    bank: [],
    factoring: [],
  };
                      ...
                      <Popover>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-karmen-ink mt-0.5">
                              {item.rationale}
                            </p>
                          </div>
                          {item.unavailableReason && (
                            <div className="pt-1 border-t border-karmen-border-blue/40">
                              ...
                              <p className="text-karmen-mute mt-0.5 italic">
                                {item.unavailableReason}
                              </p>
                            </div>
                          )}
