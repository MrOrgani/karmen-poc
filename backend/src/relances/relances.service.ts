...
import type { AugmentedDossier, MissingItem } from '../dossiers/types';
...
export class RelancesService {
  /**
   * Mock LLM. Genère un brouillon d'email à partir du dossier + missing items.
   * Branchement LLM réel (Claude/OpenAI) à activer en prod via env var.
   */
  draft(dossier: AugmentedDossier, missing: MissingItem[]): RelanceDraft {
